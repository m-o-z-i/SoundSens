...
def precomputeSound():
    ...
    toneC_L   = C(lengthFactor1 * l1, lengthFactor2 * l2)
    ...
    toneD_L   = D(lengthFactor1 * l1, lengthFactor2 * l2)
    ...
    toneE_L   = E(lengthFactor1 * l1, lengthFactor2 * l2)
    ...
    toneF_L   = F(lengthFactor1 * l1, lengthFactor2 * l2)
    ...
    toneG_L   = G(lengthFactor1 * l1, lengthFactor2 * l2)
    ...
    toneA_L   = A(lengthFactor1 * l1, lengthFactor2 * l2)
...
def C(length1, length2):
  return islice(damped_wave(frequency=180.0, amplitude=1, length=int(length1)), length2)

def D(length1, length2):
  return islice(damped_wave(frequency=210.0, amplitude=1, length=int(length1)), length2)

def E(length1, length2):
  return islice(damped_wave(frequency=240.0, amplitude=1, length=int(length1)), length2)

def F(length1, length2):
  return islice(damped_wave(frequency=270.0, amplitude=1, length=int(length1)), length2)

def G(length1, length2):
  return islice(damped_wave(frequency=300.0, amplitude=1, length=int(length1)), length2)

def A(length1, length2):
  return islice(damped_wave(frequency=330.0, amplitude=1, length=int(length1)), length2)
